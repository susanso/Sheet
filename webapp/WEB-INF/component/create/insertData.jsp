...
<link rel="stylesheet" type="text/css" href="../css/create/insertData.css">
	...
	<div class="InputContainer">
		<div class="SongInfoInputContainer">
			...
			<div class="Input">
				...
				<label for="song_name">
					<input type="text" class="input_label song_name">
				</label>
			</div>
			<div class="Input">
				<div class="InputBar">가수명</div>
				<label for="artist">
					<input type="text" class="input_label artist">
				</label>
			</div>
			<div class="Input">
				<div class="InputBar">작성자</div>
				<label for="producer_name">
					<input type="text" class="input_label producer_name">
				</label>
			</div>
			<div class="Input">
				<div class="InputBar">장르</div>
				<label for="genre">
					<input type="text" class="input_label genre">
				</label>
			</div>
			<div class="Input">
				<div class="InputBar">키</div>
				<label for="key">
					<input type="text" class="input_label key">
				</label>
			</div>
			<div class="Input">
				<div class="InputBar">BPM</div>
				<label for="bpm">
					<input type="text" class="input_label bpm">
				</label>
			</div>
			<div class="Input">
				<div class="InputBar">송폼</div>
				<label for="song_form">
					<input type="text" class="input_label song_form">
				</label>
			</div>
			<div class="Input">
				<div class="InputBar">박자</div>
				<label for="beat">
					<input type="text" class="input_label beat">
				</label>
			</div>
			<div class="Input">
		...
		<div class="InstInfoInputContainer">
			<div class="inst_info">트랙 정보 테이블</div>
				...
				<div class="Input">
					...
					<label for="trackNum">
						<input type="text" class="input_label trackNum">
					</label>
				</div>
				<div class="Input">
					<input type="button" class="trackNumButton" value="입력">
				</div>
				<div class = "scroll_container inst_container">
				</div>
				<div class="Input">
			...
			<div class="chord_info">코드 정보 테이블</div>
				...
				<div class="Input">
					...
					<label for="measureNum">
						<input type="text" class="input_label measureNum">
					</label>
				</div>
				<div class="Input">
					<input type="button" class="measureNumButton" value="입력">
				</div>
				<div class="scroll_container chord_container">
				</div>
				<div class="Input">
